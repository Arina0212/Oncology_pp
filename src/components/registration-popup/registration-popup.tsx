...
const RegistrationPopup: React.FC =() => {
    const modalRefReg = useRef<HTMLDialogElement>(null)
    function openModalReg() {
        modalRefReg.current?.showModal()
    };
    function closeModalReg(){
        modalRefReg.current?.close()
    };
    return(
        <>
            <span onClick={openModalReg} id="openRegisBtn"> Зарегистрироваться</span>
            <dialog ref={modalRefReg} className="modal modal_regis">
                <form className="modal__content" method="dialog">
                    <button onClick={closeModalReg} className="modal__content-close" id="closeRegisBtn">
                    ...
                    <div className="modal_regis__inputs">
                        ...
                        <div className="modal__content-input-box">
                            <input type="password" className="modal__content-input-box-input" id="newPassword" placeholder="Пароль"
                                required/>
                            ...
                            <div className="modal__content-input-box-hide" id="hidePass">
                        ...
                        <div className="modal__content-input-box">
                            <input type="password" className="modal__content-input-box-input" id="confirmNewPassword"
                            ...
                            <div className="modal__content-input-box-tick" >
                    ...
                    <p className="modal__content-text">Нет аккаунта? <span id="openAuthBtn">Войдите</span></p>
                </form>
            </dialog>
        </>
    )
